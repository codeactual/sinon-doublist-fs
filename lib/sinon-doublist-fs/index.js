...
function sinonDoublistFs(test) {
  ...
  fileStubMap = {};
  addInternalProp(test, 'fsStub', fsStub);
  addInternalProp(test, 'fileStubMap', fileStubMap);
}
...
mixin.stubFile = function(name) {
  ...
  var fileStub = new FileStub(getInternalProp(this, 'fsStub'));
...
var globalInjector = {
  mocha: function() {
    beforeEach(function(hookDone) { sinonDoublistFs(this); hookDone(); });
    afterEach(function(hookDone) { this.restoreFs(); hookDone(); });
  }
};
