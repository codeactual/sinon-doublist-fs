...
customFsStub.renameSync = function(oldPath, newPath) {
  ...
  log('1. oldPath: %s, oldPathStub.name: %s', oldPath, oldPathStub.get('name'));
  ...
  log('2. oldPath: %s, oldPathStub.name: %s', oldPath, oldPathStub.get('name'));
  fileStubMap[newPath].set('name', newPath);
  log('3. oldPath: %s, oldPathStub.name: %s', oldPath, oldPathStub.get('name'));
  fileStubMap[newPath].make();
  log('4. oldPath: %s, oldPathStub.name: %s', oldPath, oldPathStub.get('name'));
  ...
  log('L. oldPath: %s, oldPathStub.name: %s', oldPath, oldPathStub.get('name'));
